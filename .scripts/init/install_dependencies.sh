...
LINUX_DEPENDENCIES=("arandr" "alsa-utils" "feh" "ripgrep" "dmenu" "wireless_tools" "pulseaudio" "pulseaudio-alsa" "sxiv" "ranger" "light" "physlock" "dunst" "bmon" "nethogs" "htop" "bluez" "bluez-utils" "libnotify")
MACOS_DEPENDENCIES=()
install_dep() {
